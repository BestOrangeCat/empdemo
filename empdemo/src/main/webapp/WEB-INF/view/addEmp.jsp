...
<div class="container">
    ...
    <div class="row body">
        <form class="form-horizontal" id="add_Emp" action="${pageContext.request.contextPath}/emp/addEmp">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 phone_legitimate">
                    <input type="text" class="form-control" id="phone" placeholder="phone" onkeyup="value=value.replace(/[^\d]/g,'')" name="phone">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 salary_legitimate">
                    <input type="text" class="form-control" id="salary" name="salary" placeholder="salary" onkeyup="value=value.replace(/[^\d]/g,'')">
                </div>
            </div>
            <div class="form-group">
